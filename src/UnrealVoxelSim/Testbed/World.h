...
class World final
{
  public:
    ...
    [[nodiscard]] std::optional<Movement::Api::State> ReadPawn(Ecs::Api::EntityId entity) const noexcept;
    [[nodiscard]] std::optional<Navigation::Api::ExecutionStatus> ReadNavigation(
        Ecs::Api::EntityId entity) const noexcept;
...
class WorldCatalog final
{
  public:
    ...
    [[nodiscard]] static std::unique_ptr<World> Create(std::string_view id,
